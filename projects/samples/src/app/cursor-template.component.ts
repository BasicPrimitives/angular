...
@Component({
  selector: 'app-cursor-template',
  templateUrl: './cursor-template.component.html',
  styleUrls: ['./sample.css', './cursor-template.component.css']
})
export class CursorTemplateComponent {
